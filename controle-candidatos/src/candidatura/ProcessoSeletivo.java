...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionados(){
        ...
        System.out.println("Forma abreviada de interação do método imprimirSelecionados utilizando o for each, nesse modelo não imprimos o i que corresponde ao índice do array");
        for(String candidato : candidatos) {
